...
-   [[ggrepel]{.underline}](ggrepel%20provides%20geoms%20for%20ggplot2%20to%20repel%20overlapping%20text%20labels:) - ggrepel provides geoms for ggplot2 to repel overlapping text labels. Text labels repel away from each other, away from data points, and away from edges of the plotting area.
