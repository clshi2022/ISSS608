...
**(c)** [Unclear segregation between axis and graph area]{.underline}. Similar to the previous point, the segregation between the axis and the graph area is not clear. recommended to give the axis another colour.Remake of the visualistion in 'R' using ggplot2.
